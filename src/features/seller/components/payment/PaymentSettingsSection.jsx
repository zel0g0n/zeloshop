...
import { Lightbulb, CreditCard, Landmark, Package, Check, AlertTriangle, Loader2 } from "lucide-react";
...
/**
 * "To'lov tizimlari" bo'limining ICHKI KONTENTI — sarlavha/orqaga
 * tugmasi/tashqi to'liq ekran o'rovisiz.
 *
 * 2026-09 foydalanuvchi so'roviga ko'ra: "To'lov va Tariflar" (
 * `TariffsSection.jsx`) bilan BITTA sahifada, tab-filtr orqali
 * almashtiriladigan ikki bo'lim sifatida birlashtirildi (`PaymentAndTariffsPage.jsx`,
 * `DeliverySettingsPage.jsx`dagi bilan BIR XIL naqsh). Mantiqning O'ZI
 * (Click/Payme/jismoniy shaxs sozlamalari, checkout usullari) BU
 * FAYLGA, `PaymentSettingsPage.jsx`dan O'ZGARISHSIZ ko'chirildi — faqat
 * tashqi sahifa o'rovi (header/orqaga tugmasi) olib tashlandi, chunki
 * endi buni ORTIQ komponent (`PaymentAndTariffsPage.jsx`) beradi.
 *
 * MUHIM: bu bo'limning ICHIDA O'ZINING mustaqil ikkinchi darajali
 * tabi ("Jismoniy shaxs"/"Yuridik shaxs", `activeTab` holati) hamon
 * bor — bu, tashqi (Payment/Tariflar) tab bilan ARALASHMAYDI, ular
 * ikki xil daraja (ichma-ich tab, xuddi shu naqsh boshqa joyda ham
 * ishlatiladi va tabiiy ko'rinadi).
 */
