...
import { ArrowLeft, PackagePlus, Search, ImageOff, Check, Trash2, Loader2 } from "lucide-react";
 ...
 * mahsulotni birlashtirib, ularga umumiy (individual narxlar
 * yig'indisidan PASTROQ) combo narx belgilaydi. Mijoz mahsulot
 * sahifasida shu combo'ni ko'radi va bosilganda BARCHA mahsulotlar
 * bir yo'la savatga qo'shiladi.
 *
  ...
  return (
    <div className="min-h-screen bg-[#F4F5F9] dark:bg-slate-950 text-slate-900 dark:text-white font-sans antialiased pb-36 transition-colors duration-300">
      <div className="sticky top-0 z-30 bg-white/95 dark:bg-slate-900/95 px-4 py-4 shadow-xs flex items-center gap-3">
        ...
        <div>
          <h1 className="text-base font-black text-slate-800 dark:text-white">{t("bundleManagement.title")}</h1>
          <p className="text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-wider">{t("bundleManagement.subtitle")}</p>
        </div>
      </div>
