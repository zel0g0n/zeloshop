...
import { ArrowLeft, Bike, Plus, Check, Send, Trash2, Loader2, X, PhoneCall } from "lucide-react";
...
/**
 * Sotuvchi — "Kuryerlar" sahifasi.
 *
 * `ConnectionsPage.jsx`dagi "ulash/uzish" UI naqshiga o'xshab qurilgan
 * (kartochka + forma + ro'yxat), lekin kuryerlar ko'p (ro'yxat), bitta
 * ulanish emas. Kuryer qo'shish taklif havolasi yaratish orqali amalga
 * oshadi: sotuvchi ismni kiritadi, tizim havola yasaydi, sotuvchi buni
 * o'zi (WhatsApp/Telegram/SMS) kuryerga yuboradi — bot o'zi xabar
 * yubormaydi, chunki kuryerning Telegram ID'si hali noma'lum (u faqat
 * botga /start bosgandan keyin ma'lum bo'ladi). Kuryer botga ulangach,
 * ro'yxatda real vaqtda (onSnapshot) paydo bo'ladi — sahifani yangilash
 * shart emas.
 */
